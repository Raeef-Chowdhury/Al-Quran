    ...
    <>
      ...
      <div className="flex items-center justify-around max-lg:hidden">
        <div className="header__title">
          <div className="text-primary transition-all transition-300ms hover:scale-110 hover:cursor-pointer">
        ...
        <ul className="header__access flex gap-24 items-center justify-between">
          <li>
      ...
      <div className="min-lg:hidden flex justify-between items-center">
        ...
        <button onClick={toggleSidebar} className="text-primary text-[7.2rem]">
          {open ? "✕" : "☰"}
        </button>
      </div>
        ...
        {open ? (
          ...
          >
            <button
              ...
              className="text-red-500 text-[6.4rem] mb-[18rem]"
            >
              ✕
            </button>

            <nav className="flex flex-col gap-[6.4rem] text-[4.8rem] items-center justify-center">
              <ul className="flex flex-col gap-[6.4rem] text-[4.8rem] items-center justify-center">
                <li>
                  <Link
                    to={"/Home"}
                    className="hover:bg-shade/10 px-[4rem] py-[1rem] block"
                    onClick={() => setOpen(!open)}
                  >
                    Home
                  </Link>
              ...
              <button
                onClick={toggleTheme}
                className="text-[2.4rem] mt-[2.4rem] theme__icon hover:bg-shade/10 hover:text-background transition-all transition-300ms cursor-pointer rounded-full p-2"
              >
                {isDark ? (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
