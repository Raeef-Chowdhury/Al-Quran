...
function HeaderContent({ currentPath }) {
  ...
  return (
    <>
      <ul className="flex items-center justify-around max-lg:hidden">
      ...
      <div className="min-lg:hidden flex justify-between items-center list-none">
        <li className="text-primary  transition-all transition-300ms hover:scale-110 hover:cursor-pointer ">
          <div className="h-[9.6rem] scale-150 flex items-center">
            <img
              src="/src/assets/remove-photos-background-removed.png"
        ...
        {open ? (
          ...
          >
            ...
            <nav className="flex flex-col gap-[6.4rem] text-[4.8rem] items-center justify-center">
              <Link to={"/Home"}>
                <li
                  className="list-none hover:bg-shade/10 px-[4rem]  py-[1rem]"
                  onClick={() => setOpen(!open)}
                >
                  Home
                </li>
              ...
              <li
                onClick={toggleTheme}
                className="text-[2.4rem] mt-[2.4rem] list-none theme__icon hover:bg-shade/10 hover:text-background transition-all transition-300ms cursor-pointer rounded-full p-2"
              >
                {isDark ? (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
